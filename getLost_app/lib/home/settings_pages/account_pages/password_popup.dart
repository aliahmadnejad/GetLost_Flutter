...
class PasswordPopup extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return PasswordPopupState(token: token);
  }
}

class PasswordPopupState extends State<PasswordPopup> {
  final String token;
  PasswordPopupState({this.token});
    ...
    return Align(
        ...
        child: Material(
          ...
          child: Container(
            ...
            margin: EdgeInsets.only(top: 200, bottom: 380, left: 30, right: 30),
