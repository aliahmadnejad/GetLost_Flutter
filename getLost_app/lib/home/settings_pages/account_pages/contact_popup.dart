...
class ContactPopup extends StatefulWidget {
  final String token;
  ContactPopup({Key key, @required this.token}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return ContactPopupState(token: token);
  }
}

class ContactPopupState extends State<ContactPopup> {
  final String token;
  ContactPopupState({this.token});
              ...
              child: Column(children: <Widget>[
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    // labelText: 'Username',
                    hintText: '${applicationBloc.travelerInfo.phone}',
                    hintStyle: TextStyle(
                        color: Color(0xff9F9F9F),
                        fontFamily: "SF-Pro-Regular",
                        fontSize: 16),
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    // labelText: 'Username',
                    hintText: '${applicationBloc.travelerInfo.user.email}',
                    hintStyle: TextStyle(
                        color: Color(0xff9F9F9F),
                        fontFamily: "SF-Pro-Regular",
                        fontSize: 16),
